...
@EnableJpaRepositories(basePackages = "edu.logos.homewrk.repository")
@ComponentScan(basePackages = {"edu.logos.homewrk.repository","edu.logos.homewrk.service"})
...
public class DatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean getEntityManagerFactory() throws PropertyVetoException {
        ...
        emf.setPackagesToScan(new String[] {"edu.logos.homewrk.entity"}); // Entity package
